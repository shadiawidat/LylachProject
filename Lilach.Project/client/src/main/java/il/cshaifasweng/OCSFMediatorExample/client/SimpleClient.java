...
public class SimpleClient extends AbstractClient {
    ...
    protected void handleMessageFromServer(Object msg) {
        ...
        if (deliver.equals("#CatalogReady") && catalogControl != null) {
            ...
            Platform.runLater(() -> {
                catalogControl.LoadList(Catalog.Catalog);
            ...
            Catalog.Catalog = (List<Item>) ms.getObject();
            Platform.runLater(() -> {
                catalogControl.RefreshList((List<Item>) ms.getObject());
            });
        } else if (deliver.equals("#UserExists")) {
            Platform.runLater(() -> {
                signUpControl.UserExist();
            });
            ...
            Platform.runLater(() -> {
                cartControl.loadCart((List<Item>) ms.getObject());
            });
