...
public class App {
    ...
    private static void generateItems() throws Exception {
        ...
        User user= new User("F","f","Noor","Abu elfoul","Noorabo7@outlook.com","0528218268",new Date(2000-1900,7-1,26+1),"Shefa'amer",permissions.ADMIN ,"123456789","123546789",false);
        ...
        //Branch Managers
        BranchManager Manager=new BranchManager("moshe","Grossman","Moshe","Grossman","malkigr@gmail.com","0549999999",new Date(1960-1900,10-1,18+1),"Haifa",permissions.MANAGER,"321551287","4580160005429090",false,b1);
        server.saveObject(Manager);

        Manager=new BranchManager("profmalki","Grossman","Malki","Grossman","malkigr@gmail.com","0549999999",new Date(1960-1900,10-1,18+1),"Haifa",permissions.MANAGER,"321551287","4580160005429090",false,b2);
        server.saveObject(Manager);

        Manager=new BranchManager("eli","albyan","Elias","Haddad","Info@albyan.net","0548888888",new Date(1960-1900,7-1,16+1),"Haifa",permissions.MANAGER,"321654127","4580160005429090",false,b3);
        server.saveObject(Manager);
        ...
        //Worker
        user= new User("johnny","CSapple","John Pierre","Haddad","John.pierre.haddad@gmail.com","0547705173",new Date(1997-1900,1-1,01+1),"Haifa",permissions.WORKER,"123456789","123456789" ,false,b1);
        server.saveObject(user);
        user= new User("lili","LilianCs","Lilian","Mansour","Lilianmansour3@gmail.com","0528345268",new Date(2000-1900,8-1,16+1),"Haifa",permissions.WORKER,"123456789","123456789",false,b3 );
        server.saveObject(user);
        user= new User("shaggy","Shadi123","Shadi","Awidat","Shadiawidat2001@gmail.com","0528020276",new Date(2001-1900,10-1,18+1),"Majdal shams",permissions.WORKER,"123456789","123456789" ,false,b2);
        server.saveObject(user);
